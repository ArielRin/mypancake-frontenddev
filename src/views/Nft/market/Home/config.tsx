  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on SirensTreasure.'),
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by SirensTreasure from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
