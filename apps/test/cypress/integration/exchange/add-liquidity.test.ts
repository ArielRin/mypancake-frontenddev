describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    cy.visit('/add/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56')
  ...
  it('loads the BNB and tokens', () => {
    cy.visit('/add/BNB/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0')
  ...
  it('loads the WBNB and tokens', () => {
    cy.visit('/add/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0')
  ...
  it('does not crash if address is duplicated', () => {
    cy.visit('/add/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0')
    cy.get('#add-liquidity-select-tokena #pair').should('contain.text', 'CAKE')
    cy.get('#add-liquidity-select-tokenb #pair').should('not.contain.text', 'CAKE')
  })

  it('token not in storage is loaded', () => {
    cy.visit('/add/0xD74b782E05AA25c50e7330Af541d46E18f36661C/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0')
  ...
  it('redirects /add/token-token to add/token/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56',
    )
  })

  it('redirects /add/BNB-token to /add/BNB/token', () => {
    cy.visit('/add/BNB-0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0')
    cy.url().should('contain', '/add/BNB/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0')
  })

  it('redirects /add/token-BNB to /add/token/BNB', () => {
    cy.visit('/add/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0-BNB')
    cy.url().should('contain', '/add/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0/BNB')
  })
  ...
  it('redirects /add/WBNB to /add/WBNB/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0',
    )
  })

  it('redirects /add/token-WBNB to /add/token/WBNB', () => {
    cy.visit('/add/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0-0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c')
    cy.url().should(
      'contain',
      '/add/0x1eC89DC2aAF23f86534535f0c87efff3C3887Eb0/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c',
    )
  })
})
