describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    cy.visit('/add/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56')
  ...
  it('loads the BNB and tokens', () => {
    cy.visit('/add/BNB/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76')
  ...
  it('loads the WBNB and tokens', () => {
    cy.visit('/add/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76')
  ...
  it('does not crash if address is duplicated', () => {
    cy.visit('/add/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76')
    cy.get('#add-liquidity-select-tokena #pair').should('contain.text', 'CAKE')
    cy.get('#add-liquidity-select-tokenb #pair').should('not.contain.text', 'CAKE')
  })

  it('token not in storage is loaded', () => {
    cy.visit('/add/0xD74b782E05AA25c50e7330Af541d46E18f36661C/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76')
  ...
  it('redirects /add/token-token to add/token/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56',
    )
  })

  it('redirects /add/BNB-token to /add/BNB/token', () => {
    cy.visit('/add/BNB-0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76')
    cy.url().should('contain', '/add/BNB/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76')
  })

  it('redirects /add/token-BNB to /add/token/BNB', () => {
    cy.visit('/add/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76-BNB')
    cy.url().should('contain', '/add/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76/BNB')
  })
  ...
  it('redirects /add/WBNB to /add/WBNB/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76',
    )
  })

  it('redirects /add/token-WBNB to /add/token/WBNB', () => {
    cy.visit('/add/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76-0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c')
    cy.url().should(
      'contain',
      '/add/0xA10Fe7C361B7445348c9b37B1F2F25fc9ED73C76/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c',
    )
  })
})
