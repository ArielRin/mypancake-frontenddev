...
export const darkColors = {
  ...
  input: '#372F47',
  inputSecondary: '#9A6AFF80',
  primaryDark: '#9A6AFF80',
  tertiary: '#353547',
  text: '#F4EEFF',
  text99: '#F4EEFF99',
  textDisabled: '#666171',
  textSubtle: '#666171',
  disabled: '#524B63',
  gradientBubblegum: 'linear-gradient(139.73deg, #1e7069 0%, #0098A1 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #1e7069 0%, #0098A1 100%)',
  ...
  gradientVioletAlt: 'linear-gradient(180deg, #1e7069 0%, #0098A1 100%)',
  gradientGold: 'linear-gradient(180deg, #FFD800 0%, #FDAB32 100%)',
}
